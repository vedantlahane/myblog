  ...
  template: `
    <div class="min-h-screen bg-ui-background py-12">
      ...
      <section class="mx-auto mt-16 max-w-5xl rounded-3xl border border-ui-border bg-ui-surface p-8 shadow-sm">
        ...
        <div class="grid gap-8 md:grid-cols-2 md:items-center">
          <div class="space-y-6 text-left text-text-secondary">
            <p class="text-lg">
              MyBlog was born from a simple belief: <strong class="text-text-primary">great ideas deserve great presentation</strong>. In an era of information overload, we wanted to create a space where thoughts could breathe, where stories could unfold naturally, and where readers could truly connect with content.
            </p>
            <p>
      ...
      <section class="mx-auto mt-16 max-w-5xl rounded-3xl bg-brand-navy p-8 text-white shadow-md">
        <h2 class="mb-8 text-center text-3xl font-semibold">Why MyBlog is Different</h2>
      ...
      <section class="mx-auto mt-16 max-w-5xl grid gap-8 md:grid-cols-2">
          ...
          <div class="space-y-4 text-left text-text-secondary">
            <div class="flex items-start gap-3">
              ...
              <div>
                ...
                <a href="mailto:hello@myblog.com" class="text-brand-blue hover:text-brand-blue/80">hello&#64;myblog.com</a>
              </div>
            </div>
            <div class="flex items-start gap-3">
              <svg class="h-5 w-5 text-brand-blue" fill="currentColor" viewBox="0 0 20 20">
              ...
              <div>
                ...
                <span class="text-text-primary">www.myblog.com</span>
              </div>
            </div>
            <div class="flex items-start gap-3">
              <svg class="h-5 w-5 text-brand-blue" fill="currentColor" viewBox="0 0 20 20">
        ...
        <div class="rounded-3xl border border-ui-border bg-ui-surface p-8 shadow-sm">
          ...
          <div class="space-y-4 text-left">
            <div>
              <h4 class="mb-2 text-lg font-semibold text-text-primary">Can anyone write for MyBlog?</h4>
            ...
            <div>
              <h4 class="mb-2 text-lg font-semibold text-text-primary">Is MyBlog free?</h4>
